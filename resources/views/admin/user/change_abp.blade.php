                ...
                <ul class="nav nav-tabs e-s-side" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="add-tab" href="#add" aria-controls="add"
                           data-toggle="tab" role="tab" aria-selected="true"><span class="fa fa-plus"></span>Add ABP</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="substract-tab" href="#substract" aria-controls="substract"
                           data-toggle="tab" role="tab" aria-selected="true"><span class="fa fa-minus"></span>Substract ABP</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="transfer-tab" href="#transfer" aria-controls="transfer"
                           data-toggle="tab" role="tab" aria-selected="true"><span class="fa fa-lock"></span>Transfer ABP</a>
                    </li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade active show" id="add" role="tabpanel" aria-labelledby="add-tab">
                        <div class="change-section">
                            <form action="{{route('admin.user.add.abp',['user_id'=>$user->id])}}" method="post">
                                @csrf
                                <div class="row">
                    ...
                    <div class="tab-pane fade  show" id="substract" role="tabpanel" aria-labelledby="add-tab">
                        <div class="change-section">
                            <form action="{{route('admin.user.substract.abp',['user_id'=>$user->id])}}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-md-4" style="display: flex;">
                                        <h5>UserName</h5><span style="color: red;">*</span>
                    ...
                    <div class="tab-pane fade  show" id="transfer" role="tabpanel" aria-labelledby="add-tab">
                        <div class="change-section">
                            <form action="{{route('admin.user.transfer.abp',['user_id'=>$user->id])}}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-md-4" style="display: flex;">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="to_username" class="form-control @error('to_username') is-invalid @enderror" id="transfer-username" value="" required>
                                        <br>
                                    </div>
                                    <div class="col-md-4" style="display: flex;">
                                        <h5>Amount($)</h5><span style="color: red;">*</span>
